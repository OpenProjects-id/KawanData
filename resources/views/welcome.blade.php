                ...
                <div class="col-lg-11 col-12">
                    <div class="row">
                        <div class="col-lg-6 col-12 copywriting">
                            ...
                            <p class="support">
                                Kami di <span class="text-purple">KawanData</span> berusaha untuk membantu mereka <br> yang ingin belajar dan memulai karir menjadi <span class="text-purple">Data Scientist</span>.
                            </p>
                            <p class="cta">
        ...
        <div class="container">
            <div class="row item-step pb-70">
                ...
                <div class="col-lg-6 col-12 text-left copywriting">
                    ...
                    <p class="support">
                        Kami sangat peduli terhadap mentee-mentee yang belajar <br>di tempat kami sehingga akan ada sesi wawancara <br>untuk mengetahui potensi mentee di masa depan
                    </p>
                    <p class="mt-5">
            ...
            <div class="row item-step pb-70">
                <div class="col-lg-6 col-12 text-left copywriting pl-150">
                    ...
                    <p class="support">
                        Setiap mentee akan diundang ke dalam grup untuk saling berdiskusi dan juga berkonsultasi perihal proyek akhir
                    </p>
                    <p class="mt-5">
                        <a href="#" class="btn btn-master btn-secondary me-3">
                            Lihat Demo
            ...
            <div class="row item-step">
                ...
                <div class="col-lg-6 col-12 text-left copywriting">
                    ...
                    <p class="support">
                        Belajar bagaimana mempresentasikan hasil kerja kamu dalam <br>proyek akhir dengan kemampuan presentasi dan juga story telling.
                    </p>
                    <p class="mt-5">
                        <a href="#" class="btn btn-master btn-secondary me-3">
                            Showcase
        ...
        <div class="container">
            <div class="row pb-70">
                <div class="col-lg-5 col-12 header-wrap copywriting">
                    ...
                    <p class="support">
                        Kami punya beberapa modul kemampuan data <br>yang bisa kamu pelajari dan semuanya <span class="story">GRATIS</span>
                    </p>
                    <p class="mt-5">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12 py-3">
                            <div class="table-pricing paket-biasa">
                                ...
                                <p>
                                    <a href="{{ route('checkout', 'basic-python') }}" class="btn btn-master btn-primary w-100 mt-3">
                                        Ambil Kelas Ini
                                    </a>
                                </p>
                            </div>
                        ...
                        <div class="col-lg-6 col-12 py-3">
                            <div class="table-pricing paket-biasa">
                                ...
                                <p>
                                    <a href="{{ route('checkout', 'basic-data-science') }}" class="btn btn-master btn-secondary w-100 mt-3">
                                        Ambil Kelas Ini
                                    </a>
                                </p>
                            </div>
        ...
        <div class="border-color info-footer">
            ...
            <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
                <div class="d-flex title-font font-medium align-items-center gap-4">
                    ...
                    <a href="">
                        <svg class="social-media-p" width="30" height="30" viewBox="0 0 30 30" fill="#4D1DAB"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
                    <p style="margin: 0">Copyright © 2021 Kawan Data</p>
                </nav>
            </div>
        </div>
