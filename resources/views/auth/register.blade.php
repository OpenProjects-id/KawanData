        ...
        <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row"
            ...
            <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
                <div class="right mx-lg-0 mx-auto">
                    ...
                    <img src="{{ asset('images/logo.png') }}" alt="" width="410px" height="80px"
                        class="mb-5">
                    ...
                    <form style="margin-top: 1.5rem" action="{{ route('register.post') }}" method="post">
                        ...
                        <div style="margin-bottom: 1.75rem">
                            <label for="name" class="d-block input-label">Nama</label>
                            <div class="d-flex w-100 div-input">
                                <i class="fas fa-id-card-alt icon mt-1" style="margin-right: 1rem; color: #CACBCE"></i>
                                <input class="input-field border-0" type="text" name="name" id="name"
                                    placeholder="Nama lengkap" autocomplete="on" value="{{ old('name') }}" autofocus
                        ...
                        <div style="margin-bottom: 1.75rem">
                            <label for="email" class="d-block input-label">Alamat Email</label>
                            <div class="d-flex w-100 div-input">
                        ...
                        <div style="margin-top: 1rem">
                            <label for="password" class="d-block input-label">Kata Sandi</label>
                            <div class="d-flex w-100 div-input">
                                <svg class="icon" style="margin-right: 1rem" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <input class="input-field border-0 password" type="password" name="password"
                                    id="password" placeholder="Masukkan kata sandi" minlength="8"
                        ...
                        <div style="margin-top: 1rem">
                            <label for="password_confirmation" class="d-block input-label">Konfirmasi Kata
                                Sandi</label>
                            <div class="d-flex w-100 div-input">
                                <svg class="icon" style="margin-right: 1rem" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <input class="input-field border-0 password" type="password"
                                    name="password_confirmation" id="password-confirmation"
                                    placeholder="Masukkan ulang kata sandi" minlength="8" required />
                            </div>
                        </div>
                        ...
                        <a class="btn btn-google d-block w-100 mt-3" type="submit"
                            ...
                            <img src="{{ asset('images/ic_google.svg') }}" class="icon"
                    ...
                    <p class="text-center bottom-caption">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" style="text-decoration: none;"><span
                                class="green-bottom-caption">Masuk Disini</span></a>
                    </p>
                </div>
            </div>
        </div>
