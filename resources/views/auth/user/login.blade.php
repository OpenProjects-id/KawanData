        ...
        <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row"
            ...
            <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
                <div class="right mx-lg-0 mx-auto">
                    ...
                    <img src="{{ asset('images/logo.png') }}" alt="" width="300px" height="70px"
                        class="mb-5">
                    ...
                    <form style="margin-top: 1.5rem" action="" method="post">
                        ...
                        <div style="margin-bottom: 1.75rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" type="email" name="email" value="{{ old('email') }}" id="email"
                                    placeholder="Masukkan Alamat Email" autocomplete="off" autofocus required />
                            </div>
                            @error('email')
                        ...
                        <div style="margin-top: 1rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" type="password" name="password"
                                    id="password-content-3-5" placeholder="Masukkan Kata Sandi" minlength="6"
                                    required />
                    ...
                    <p class="text-center bottom-caption">
                        Belum punya akun?
                        <a href="{{ route('register') }}" style="text-decoration: none;"><span
                                class="green-bottom-caption">Daftar
                                Disini</span></a>
                    </p>
                </div>
            </div>
